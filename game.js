...
window.onload = function(){
  ...
  alert("The team Lunatic Duo is happy to have developed this interesting and challenging game!!")
...
highScoreSound.src = "Sounds/highscore.mp3";
...
// timer division
    ...
    fwBuilder.prototype.draw = function(){
        for(var i = 0; i < this.n; i++){
            ctx2.beginPath();
            ctx2.arc(this.balls[i].x,this.balls[i].y,5,0,Math.PI*2);
            ctx2.fill();
            ctx2.closePath();
